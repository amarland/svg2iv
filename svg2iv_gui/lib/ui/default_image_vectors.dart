      ...
      .addNode(
        VectorPathBuilder(
          [
            ...
            const PathNode(PathDataCommand.lineTo, [37.0, 0.0]),
            const PathNode(PathDataCommand.lineTo, [0.0, 53.0]),
            const PathNode(PathDataCommand.lineTo, [59.0, 0.0]),
            const PathNode(PathDataCommand.lineTo, [0.0, 78.0]),
            const PathNode(PathDataCommand.lineTo, [74.0, 0.0]),
            const PathNode(PathDataCommand.lineTo, [0.0, 39.0]),
            ...
            const PathNode(PathDataCommand.lineTo, [0.0, 36.0]),
            const PathNode(PathDataCommand.lineTo, [48.0, 12.0]),
            const PathNode(PathDataCommand.lineTo, [80.0, 36.0]),
            const PathNode(PathDataCommand.lineTo, [0.0, 84.0]),
            const PathNode(PathDataCommand.lineTo, [53.0, 0.0]),
            const PathNode(PathDataCommand.lineTo, [0.0, 59.0]),
            const PathNode(PathDataCommand.lineTo, [43.0, 0.0]),
            const PathNode(PathDataCommand.lineTo, [0.0, 84.0]),
            const PathNode(PathDataCommand.lineTo, [16.0, 0.0]),
          ],
        ).build(),
      )
      .build();
      ...
      .addNode(
        VectorPathBuilder(
          [
            ...
            const PathNode(PathDataCommand.lineTo, [13.0, 0.0]),
            const PathNode(PathDataCommand.lineTo, [0.0, 17.0]),
            const PathNode(PathDataCommand.lineTo, [11.0, 0.0]),
            const PathNode(PathDataCommand.lineTo, [0.0, 15.0]),
            const PathNode(PathDataCommand.moveTo, [11.0, 7.0]),
            const PathNode(PathDataCommand.lineTo, [13.0, 0.0]),
            const PathNode(PathDataCommand.lineTo, [0.0, 13.0]),
            const PathNode(PathDataCommand.lineTo, [11.0, 0.0]),
            const PathNode(PathDataCommand.lineTo, [0.0, 7.0]),
