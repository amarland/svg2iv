...
''')..writeln(_pathDataAsString)..writeln('}')).toString();
      final actual = StringBuffer()
          .also((buffer) => writePath(buffer, path, 0))
          .toString();
      expect(actual, expected);
...
''';
      ...
      const workingDirectory = './test_tool/kotlinc';
      final executable = '$workingDirectory/bin/kotlinc';
      ...
      try {
        final result = Process.runSync(
          ...
          [
            '-cp',
            '$workingDirectory/lib/kotlin-main-kts.jar',
            '-script',
