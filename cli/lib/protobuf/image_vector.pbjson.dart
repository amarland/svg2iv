...
//  source: lib/protobuf/image_vector.proto
//
// @dart = 2.12
...
const ImageVector$json = const {
  ...
  '2': const [
    ...
    const {'1': 'tint_color', '3': 7, '4': 1, '5': 7, '10': 'tintColor'},
...
final $typed_data.Uint8List imageVectorDescriptor = $convert.base64Decode('');
...
const Brush$json = const {
  '1': 'Brush',
  '2': const [
    const {'1': 'solid_color', '3': 1, '4': 1, '5': 7, '9': 0, '10': 'solidColor'},
...
final $typed_data.Uint8List brushDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use gradientDescriptor instead')
const Gradient$json = const {
  '1': 'Gradient',
  '2': const [
    const {'1': 'colors', '3': 1, '4': 3, '5': 7, '10': 'colors'},
...
final $typed_data.Uint8List gradientDescriptor = $convert.base64Decode('');
